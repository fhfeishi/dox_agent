...
- 最近核对：2026-09-24（W0–W2 与 W3-A 已随 `665c3ff` 入库，W3-B 首切片随 `3c3cfaa` 入库；本批收口来源正文核验、失败报告重试、全局成果页、版本编辑/导出，并通过真实本地服务浏览器与隔离成组恢复。W3-B 随本批提交完成，证据见 ITERATION §16.17。W4–W7、真实模型/OCR 仍待验）。
